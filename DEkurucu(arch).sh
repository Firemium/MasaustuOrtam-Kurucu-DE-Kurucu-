...
cinnamon() {
    sudo pacman -S cinnamon gnome-terminal && sudo pacman -S xorg lightdm lightdm-gtk-greeter
}
...
kde-mini2() {
    sudo pacman -S plasma-nm plasma-pa dolphin konsole kdeplasma-addons 
}
...
echo ""
echo -ne "❨${red}Firemium@DEkurucu${tp}❩:(${yellow}./DEkurucu(arch).sh${tp}]➢ " ; read soru
